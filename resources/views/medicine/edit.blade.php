                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01"
                            ...
                            name="purchase_price" value="{{ old('purchase_price', $medicine->purchase_price) }}"
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01"
                            ...
                            name="vat_percentage" value="{{ old('vat_percentage', $medicine->vat_percentage) }}"
                            placeholder="eg: 10">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control @error('reorder_level') is-invalid @enderror"
                            ...
                            value="{{ old('reorder_level', $medicine->reorder_level) }}" placeholder="eg: 10">
                        @error('reorder_level')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" class="form-control @error('alert_quantity') is-invalid @enderror"
                            ...
                            value="{{ old('alert_quantity', $medicine->alert_quantity) }}" placeholder="eg: 10">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control @error('shelf') is-invalid @enderror" id="shelf"
                            name="shelf" value="{{ old('shelf', $medicine->shelf) }}" placeholder="eg: A1">
                        @error('shelf')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control @error('batch_number') is-invalid @enderror"
                            ...
                            value="{{ old('batch_number', $medicine->batch_number) }}" placeholder="eg: 1234567890">
                        @error('batch_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('dosage') is-invalid @enderror" id="dosage"
                            name="dosage" value="{{ old('dosage', $medicine->dosage) }}" placeholder="eg: 10mg">
                        @error('dosage')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('igta_field') is-invalid @enderror"
                            ...
                            value="{{ old('igta_field', $medicine->igta_field ?? '') }}" placeholder="eg: 1234567890">
                        @error('igta_field')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('hns_code') is-invalid @enderror"
                            id="hns_code" name="hns_code" value="{{ old('hns_code', $medicine->hns_code ?? '') }}"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('lot_number') is-invalid @enderror"
                            ...
                            value="{{ old('lot_number', $medicine->lot_number ?? '') }}" placeholder="eg: 45785">
                        @error('lot_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('loyalty_point') is-invalid @enderror"
                            ...
                            value="{{ old('loyalty_point', $medicine->loyalty_point ?? '') }}" placeholder="eg: 10">
                        @error('loyalty_point')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
