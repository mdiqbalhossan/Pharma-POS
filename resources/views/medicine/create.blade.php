                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                            name="name" value="{{ old('name') }}" placeholder="eg: Paracetamol" required>
                        @error('name')
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="input-blocks add-product list">
                            ...
                            <input type="text" class="form-control list" placeholder="Please Enter Barcode"
                                id="barcode" name="barcode" value="{{ old('barcode') }}" placeholder="eg: 1234567890">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01"
                            ...
                            name="sale_price" value="{{ old('sale_price') }}" placeholder="eg: 100" required>
                        @error('sale_price')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01"
                            ...
                            name="purchase_price" value="{{ old('purchase_price') }}" placeholder="eg: 80" required>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="number" step="0.01"
                            ...
                            name="vat_percentage" value="{{ old('vat_percentage') }}" placeholder="eg: 10">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" class="form-control @error('shelf') is-invalid @enderror" id="shelf"
                            name="shelf" value="{{ old('shelf') }}" placeholder="eg: A1">
                        @error('shelf')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('dosage') is-invalid @enderror" id="dosage"
                            name="dosage" value="{{ old('dosage') }}" placeholder="eg: 10mg">
                        @error('dosage')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="input-blocks">
                            ...
                            <div class="input-group-icon calender-input position-relative">
                                ...
                                <input type="text"
                                    ...
                                    id="manufacturing_date" name="manufacturing_date" placeholder="Choose Date"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('hns_code') is-invalid @enderror"
                            id="hns_code" name="hns_code" value="{{ old('hns_code') }}" placeholder="eg: 1234567890">
                        @error('hns_code')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control @error('lot_number') is-invalid @enderror"
                            id="lot_number" name="lot_number" value="{{ old('lot_number') }}" placeholder="eg: 45785">
                        @error('lot_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                            rows="3" placeholder="eg: This is a description">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control @error('side_effects') is-invalid @enderror" id="side_effects" name="side_effects"
                            rows="3" placeholder="eg: This is a side effect">{{ old('side_effects') }}</textarea>
                        @error('side_effects')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control @error('contraindications') is-invalid @enderror" id="contraindications"
                            name="contraindications" rows="3" placeholder="eg: This is a contraindication">{{ old('contraindications') }}</textarea>
