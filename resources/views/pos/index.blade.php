        ...
        <div class="d-flex align-items-center w-50 ps-4">
            <div class="input-group">
                <input type="text" class="form-control"
                    placeholder="{{ __('Search product by name or scan barcode...') }}" id="search-medicine">
        ...
        <div class="btn-row d-sm-flex align-items-center">
            <a href="javascript:void(0);" class="btn btn-secondary mb-xs-3" data-bs-toggle="modal"
                data-bs-target="#orders"><span class="me-1 d-flex align-items-center"><i data-feather="shopping-cart"
                        class="feather-16"></i></span>{{ __('View Orders') }}</a>
            <a href="javascript:void(0);" class="btn btn-info" id="reset-pos"><span
                    class="me-1 d-flex align-items-center"><i data-feather="rotate-cw"
                        class="feather-16"></i></span>{{ __('Reset') }}</a>
            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#recents"><span
                    class="me-1 d-flex align-items-center"><i data-feather="refresh-ccw"
                        class="feather-16"></i></span>{{ __('Transaction') }}</a>
        </div>
    </div>
        ...
        <div class="col-md-12 col-lg-8">
            <div class="pos-categories tabs_wrapper">
                <div class="pos_categories_default">
                    <h5>{{ __('Categories') }}</h5>
                    <p>{{ __('Select From Below Categories') }}</p>
                    <ul class="tabs owl-carousel pos-category">
                        <li id="all">
                            <a href="javascript:void(0);">
                                <img src="assets/img/categories/category-01.png" alt="{{ __('Categories') }}">
                            </a>
                            <h6><a href="javascript:void(0);">{{ __('All Categories') }}</a></h6>
                            <span>{{ $medicineCategories->count() }} {{ __('Items') }}</span>
                        </li>
                        @foreach ($medicineCategories as $category)
                            <li id="{{ $category->slug }}">
                                <a href="javascript:void(0);">
                                    <img src="{{ $category->image }}" alt="{{ __('Categories') }}">
                                </a>
                                <h6><a href="javascript:void(0);">{{ $category->name }}</a></h6>
                                <span>{{ $category->medicine_count }} {{ __('Items') }}</span>
                            </li>
                        @endforeach
                    </ul>
                </div>
                    ...
                    <div class="tabs_container">
                        <div class="tab_content active" data-tab="all">
                            <div class="row">
                                    ...
                                    <div class="col-sm-2 col-md-6 col-lg-3 col-xl-3">
                                        <div class="product-info default-cover card" data-id="{{ $medicine->id }}">
                                            <a href="javascript:void(0);" class="img-bg">
                                                <img src="{{ $medicine->image }}" alt="{{ __('Products') }}">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between price">
                                                <span>{{ $medicine->quantity }} {{ __('Pcs') }}</span>
                                ...
                                @empty
                                    <div class="col-12">
                                        <div class="alert alert-warning">{{ __('No medicines found') }}</div>
                                    </div>
                                @endforelse
                            </div>
                        </div>
        ...
        <div class="col-md-12 col-lg-4 ps-0">
            <aside class="product-order-list">
                <div class="head d-flex align-items-center justify-content-between w-100">
                    <div class="">
                        <h5>{{ __('Order List') }}</h5>
                        <span>{{ __('Sale ID') }} : #<span class="sales_id">{{ $saleNumber }}</span></span>
                    </div>
                </div>
                ...
                <div class="product-added block-section">
                    <div class="head-text d-flex align-items-center justify-content-between">
                        <h6 class="d-flex align-items-center mb-0">{{ __('Product Added') }}<span class="count"
                        ...
                        <a href="javascript:void(0);" class="d-flex align-items-center text-danger" id="clear-cart"><span
                                class="me-1"><i data-feather="x"
                                    class="feather-16"></i></span>{{ __('Clear all') }}</a>
                    </div>
                ...
                <div class="block-section">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-4">
                                <div class="input-block">
                                    ...
                                    <input type="number" class="form-control" placeholder="{{ __('Order Tax') }}"
                                        id="tax-input">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4">
                                <div class="input-block">
                                    ...
                                    <input type="number" class="form-control" placeholder="{{ __('Shipping') }}"
                                        id="shipping-input">
                                </div>
                            </div>
                            <div class="col-12 col-sm-4">
                                <div class="input-block">
                                    ...
                                    <input type="number" class="form-control" placeholder="{{ __('Discount') }}"
                                        id="discount-input">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="order-total">
                        <table class="table table-responsive table-borderless">
                            ...
                            <tr>
                                <td class="danger">{{ __('Discount') }}</td>
                        ...
                        <div class="col-md-6 col-lg-4 item">
                            <div class="default-cover payment-option">
                                ...
                                <label for="payment-cash">
                                    <img src="assets/img/icons/cash-pay.svg" alt="{{ __('Payment Method') }}">
                                    <span>{{ __('Cash') }}</span>
                                </label>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 item">
                            <div class="default-cover payment-option">
                                ...
                                <label for="payment-card">
                                    <img src="assets/img/icons/card-pay.svg" alt="{{ __('Payment Method') }}">
                                    <span>{{ __('Card') }}</span>
                                </label>
                            </div>
                        </div>
