            ...
            <form action="{{ route('expenses.store') }}" method="POST">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-blocks date-group mt-0">
                            ...
                            <div class="input-groupicon">
                                <input type="text" name="date" id="date" class="datetimepicker @error('date') is-invalid @enderror" placeholder="Choose Date" value="{{ old('date') }}" required>
                            </div>
                        </div>
                        @error('date')
                            <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="expense_for" id="expense_for" class="form-control @error('expense_for') is-invalid @enderror" value="{{ old('expense_for') }}" required>
                        @error('expense_for')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" value="{{ old('amount') }}" min="0" step="0.01" required>
                        @error('amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
