...
<head>
    ...
    <style>
        /**
        * Internal css use because of the dom pdf not support external css
        */
        /* Purchase invoice styles */
        body {
        ...
        /* Add the extra CSS from controller */
        @isset($extra_css)
            {!! $extra_css !!}
        @endisset
    </style>
...
<body>
    <div class="invoice-container">
        <div class="header">
            <div class="logo">
                <img src="{{ $logo ?? photo_url(setting('invoice_logo')) }}" alt="Logo" class="logo-img he-50p">
        ...
        <div class="totals">
            ...
            <div class="totals-row">
                <span>{{ __('index.Tax') }}:</span><span>{{ show_amount($purchase->total_tax) }}</span>
            </div>
            <div class="totals-row">
