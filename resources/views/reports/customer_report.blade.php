    ...
    <div class="page-header report">
        <div class="add-item d-flex">
            <div class="page-title">
                ...
                <h6>View sales activity by customer</h6>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="input-blocks">
                            ...
                            <a href="{{ route('reports.customers') }}" class="btn btn-info ms-2">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
                    ...
                    <tbody>
                        @foreach ($customers as $customer)
                            <tr>
                                ...
                                <td>{{ show_amount($customer->total_sales, 2) }}</td>
                                <td>{{ show_amount($customer->total_paid, 2) }}</td>
                                <td>{{ show_amount($customer->total_due, 2) }}</td>
