    ...
    <div class="page-header report">
        <div class="add-item d-flex">
            <div class="page-title">
                ...
                <h6>View and analyze your purchase data</h6>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="input-blocks">
                            ...
                            <a href="{{ route('reports.purchases') }}" class="btn btn-info ms-2">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($purchase->status == 'received')
                                        <span class="badges status-badge">Received</span>
                                    @elseif($purchase->status == 'pending')
                                        <span class="badges status-badge bg-warning">Pending</span>
                                    @elseif($purchase->status == 'ordered')
                                        <span class="badges status-badge ordered">Ordered</span>
                                    @endif
                                </td>
                                ...
                                <td class="action-table-data">
                                    <div class="edit-delete-action">
                                        ...
                                        <a class="me-2 p-2" href="{{ route('purchases.invoice', $purchase->id) }}">
