    ...
    <div class="page-header report">
        <div class="add-item d-flex">
            <div class="page-title">
                ...
                <h6>View financial performance summary</h6>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 col-12">
                        <div class="input-blocks">
                            ...
                            <a href="{{ route('reports.profit-loss') }}" class="btn btn-info ms-2">Reset</a>
                        </div>
                    </div>
                </div>
            </form>
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <span class="badge bg-primary me-2">{{ $start_date->format('d M Y') }}</span> to
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr class="{{ $netProfit >= 0 ? 'thead-success' : 'thead-danger' }}">
                            <th>Net Profit {{ $netProfit >= 0 ? '' : '(Loss)' }}</th>
        ...
        <div class="col-lg-3 col-sm-6 col-12 d-flex">
            <div class="dash-count {{ $netProfit >= 0 ? 'border' : 'bg-danger text-white border-0' }}">
                <div class="dash-counts">
                    ...
                    <h5>Net Profit {{ $netProfit >= 0 ? '' : '(Loss)' }}</h5>
                </div>
            </div>
        </div>
    </div>
