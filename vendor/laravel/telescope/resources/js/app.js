...
window.Telescope.basePath = 'http://localhost/pharmacy';

let routerBasePath = window.Telescope.basePath + '/telescope/';

if (window.Telescope.path === '' || window.Telescope.path === '/') {
    routerBasePath = '/pharmacy/telescope';
    window.Telescope.basePath = 'http://localhost/pharmacy';
}
...
new Vue({
    ...
    data() {
        console.log('Telescope data', Telescope);
        return {
            alert: {
                type: null,
                autoClose: 0,
    ...
    methods: {
        ...
        toggleRecording() {
            axios.post(Telescope.basePath + '/telescope/telescope-api/toggle-recording');
        ...
        clearEntries(shouldConfirm = true) {
            ...
            axios.delete(Telescope.basePath + '/telescope/telescope-api/entries').then((response) => location.reload());
        },
