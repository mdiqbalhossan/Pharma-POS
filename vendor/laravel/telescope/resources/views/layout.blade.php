...
<head>
    ...
    <link href="{{ asset('public' . mix($cssFile, 'vendor/telescope')) }}" rel="stylesheet" type="text/css">
</head>
...
<body>
    <div id="telescope" v-cloak>
        ...
        <div class="container mb-5">
            <div class="d-flex align-items-stretch py-4 header">
                ...
                <button class="btn btn-muted mr-3 d-flex align-items-center py-2"
                    :class="{ active: autoLoadsNewEntries }" v-on:click.prevent="autoLoadNewEntries"
    ...
    <script src="{{ asset('public' . mix('app.js', 'vendor/telescope')) }}"></script>
</body>
