...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/select-store', [StoreSelectionController::class, 'select'])->name('store.select');
    Route::post('/set-store', [StoreSelectionController::class, 'set'])->name('store.set');
    Route::get('/change-store', [StoreSelectionController::class, 'change'])->name('store.change');
    ...
    Route::middleware('store')->group(function () {
        ...
        Route::get('medicines-import-form', [MedicineImportController::class, 'importForm'])->name('medicines.import-form');
        Route::post('medicines-import', [MedicineImportController::class, 'import'])->name('medicines.import');
        Route::get('medicines-download-sample', [MedicineImportController::class, 'downloadSample'])->name('medicines.download-sample');
