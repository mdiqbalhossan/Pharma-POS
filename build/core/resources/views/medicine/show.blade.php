                                    ...
                                    <div class="card border">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <h6 class="text-muted mb-1">{{ __('medicine.sell_unit_multiple') }}
                                                    </h6>
                                                    <p class="text-dark">
                                                        @if ($medicine->sell_unit_multiple)
                                                            <span
                                                                class="badge bg-success">{{ __('medicine.enabled') }}</span>
                                                        @else
                                                            <span
                                                                class="badge bg-secondary">{{ __('medicine.disabled') }}</span>
                                                        @endif
                                                    </p>
                                                </div>
                                                ...
                                                @if ($medicine->sell_unit_multiple && $medicine->medicine_units->count() > 0)
                                                    <div class="col-md-12 mt-3">
                                                        <h6 class="border-bottom pb-2">
                                                            {{ __('medicine.additional_units') }}</h6>
                                                        <div class="table-responsive">
                                                            <table class="table table-sm table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        <th>{{ __('medicine.unit') }}</th>
                                                                        <th>{{ __('medicine.conversion_factor') }}</th>
                                                                        <th>{{ __('medicine.sale_price') }}</th>
                                                                        <th>{{ __('medicine.purchase_price') }}</th>
                                                                        <th>{{ __('medicine.default') }}</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    @foreach ($medicine->medicine_units as $medicineUnit)
                                                                        <tr>
                                                                            <td>{{ $medicineUnit->unit->name ?? 'N/A' }}
                                                                            </td>
                                                                            <td>{{ $medicineUnit->conversion_factor }}</td>
                                                                            <td>{{ show_amount($medicineUnit->sale_price) }}
                                                                            </td>
                                                                            <td>{{ show_amount($medicineUnit->purchase_price) }}
                                                                            </td>
                                                                            <td>
                                                                                @if ($medicineUnit->is_default)
