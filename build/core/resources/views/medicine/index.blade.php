    ...
    <div class="card table-list-card">
        <div class="card-body">
            <div class="table-top">
                ...
                <div class="toolbox-delete">
                    <div class="settings-check align-items-center">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                            data-bs-target="#importMedicineModal">
                            <i data-feather="upload" class="feather-upload"></i> {{ __('medicine.import') }}
                        </button>
                    </div>
                </div>
            </div>
