...
@section('title', __('medicine_categories.edit_title'))

@section('content')
    @include('layouts.partials.breadcrumb', [
        'title' => __('medicine_categories.edit_title'),
        'subtitle' => __('medicine_categories.edit_subtitle'),
    ])
        ...
        <div class="card-body">
            <form action="{{ route('medicine-categories.update', $medicineCategory->id) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <button type="submit"
                            class="btn btn-primary">{{ __('medicine_categories.update_button') }}</button>
